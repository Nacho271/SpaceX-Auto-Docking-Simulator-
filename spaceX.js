  ...
  if(z > 5){
    ...
    if(z < 0){
      ...
      if(atrasTZ != 1){
        ...
        console.log("Boton atras TRANSLATE Z");
        atrasTZ = 1;
        console.log("atrasTZ="+atrasTZ);
      ...
      //if(adelanteTZ !=1){
        ...
        console.log("Boton adelante TRANSLATE Z");
        adelanteTZ = 1;
        console.log("AdelanteTZ=="+adelanteTZ);
    ...
    controlSpeed();
    console.log("Punto exacto TRANSLATE Z");
    console.log("ENTRO A DESACELERAR="+z);
